...
type InviteCode struct {
	ID        string    `json:"id" gorm:"primaryKey"`
	HubID     string    `json:"hubId" gorm:"not null;index"`
...
type Channel struct {
	...
	HubID     string      `json:"hubId" gorm:"not null;uniqueIndex:idx_channel_hub"`
...
type Member struct {
	...
	HubID    string    `json:"hubId" gorm:"not null;uniqueIndex:idx_user_hub"`
...
// Supports multiple devices per user - one row per (user_id, device_id, hub_id).
type MemberDeviceKey struct {
	...
	HubID     string    `json:"hubId" gorm:"not null;index:idx_device_user_hub"`
...
type ChannelKeyBundle struct {
	...
	HubID              string    `json:"hubId" gorm:"not null"`
